...
Automatically expires cached fragments based on the state of the models involved.
...
Michel Martens & Ben Alavi

Copyright (c) 2008 CitrusByte, LLC (http://www.citrusbyte.com).
